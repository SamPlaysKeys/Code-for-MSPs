#This script is immybot specific, so it will not work outside of that environment.
...
switch ($method) {
	...
	"set" {
        ...
        powercfg /setdcvalueindex $NewPlan $PowerGUID $LidClosedGUID 1
        #Lid Closed - While plugged in - 0 = Do Nothing
        powercfg /setacvalueindex $NewPlan $PowerGUID $LidClosedGUID 1
